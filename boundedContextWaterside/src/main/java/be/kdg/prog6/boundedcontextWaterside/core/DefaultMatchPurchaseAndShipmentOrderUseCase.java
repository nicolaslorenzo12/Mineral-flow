...
public class DefaultMatchPurchaseAndShipmentOrderUseCase implements MatchPurchaseAndShipmentOrderUseCase {
    ...
    public DefaultMatchPurchaseAndShipmentOrderUseCase(LoadOrCreateShipmentOrderPort loadOrCreateShipmentOrderPort, UpdateShipmentOrderPort updateShipmentOrderPort) {
        this.loadOrCreateShipmentOrderPort = loadOrCreateShipmentOrderPort;
        this.updateShipmentOrderPort = updateShipmentOrderPort;
    }

    @Override
    public void matchPurchaseAndShipmentOrderWhenArriving(MatchPurchaseAndShipmentOrderCommand matchPurchaseAndShipmentOrderCommand) {
