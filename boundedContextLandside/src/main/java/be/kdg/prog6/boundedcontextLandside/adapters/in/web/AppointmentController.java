...
public class AppointmentController {
    ...
    @PostMapping("material-truck-appointment/seller/{sellerUuid}/material/{materialUuid}/licensePlateNumbe/{licensePlateNumberOfTruck}/gate/{gateNumber}/appointment/{appointmentTime}")
    public ResponseEntity<String> makeAppointment(@PathVariable UUID sellerUuid, @PathVariable UUID materialUuid,
                                                  @PathVariable int licensePlateNumberOfTruck, @PathVariable int gateNumber,
                                                  @PathVariable LocalDateTime appointmentTime)
    {
        makeAppointmentUseCase.makeAppointment(new MakeAppointmentCommand(new Seller.CustomerUUID(sellerUuid), new Material.MaterialUUID(materialUuid),
